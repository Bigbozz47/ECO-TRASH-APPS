...
public final class ItemContainerOnboardingBinding implements ViewBinding {
  ...
  private ItemContainerOnboardingBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView imgOnboarding, @NonNull TextView tvDescription,
  ...
  public static ItemContainerOnboardingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemContainerOnboardingBinding((ConstraintLayout) rootView, imgOnboarding,
