...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnMulai,
      @NonNull ImageView imgLogo, @NonNull TextView tvTitle) {
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySplashBinding((ConstraintLayout) rootView, btnMulai, imgLogo, tvTitle);
    }
