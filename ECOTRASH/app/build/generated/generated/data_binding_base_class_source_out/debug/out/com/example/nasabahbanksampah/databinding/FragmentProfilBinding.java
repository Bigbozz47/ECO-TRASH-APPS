...
public final class FragmentProfilBinding implements ViewBinding {
  ...
  private FragmentProfilBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout headerLayout, @NonNull CardView infoCard, @NonNull CardView profileCard,
  ...
  public static FragmentProfilBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProfilBinding((ConstraintLayout) rootView, headerLayout, infoCard,
          profileCard, profilePicture, textAddress, textBank, textName, textPhone, textProfile,
          userName, userStatus);
    }
